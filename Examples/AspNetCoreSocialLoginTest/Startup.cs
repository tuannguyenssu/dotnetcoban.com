...
namespace AspNetCoreSocialLoginTest
{
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            services
                ...
                */
                ...
                {
                    //o.ClientId = Configuration["identity-server:clientid"];
                    //o.ClientSecret = Configuration["identity-server:clientsecret"];
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.Map("/test", signInApp =>
            {
                signInApp.Run(async context =>
                {
                    ...
                    {
                        await response.WriteAsync("<a href=\"/test-login\">Login</a><br>");
                    }
                    else
                    {
                        ...
                        await response.WriteAsync("<a href=\"/test-logout\">Logout</a><br>");
                    }
            ...
            app.Map("/test-login", signInApp =>
            {
                signInApp.Run(async context =>
                {
                    await context.ChallengeAsync("Google", new AuthenticationProperties(){ RedirectUri = "/test"});

                });
            });

            app.Map("/test-logout", signInApp =>
            {
                signInApp.Run(async context =>
                {
